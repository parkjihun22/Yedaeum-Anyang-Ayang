  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://kikaporn.com/ComplexGuide/detailintro"
        />

        {/* Open Graph - 소셜 미디어 공유 최적화 */}
        <meta
          property="og:title"
          content="안성아양 영무예다음 - 호수배치도"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://kikaporn.com/ComplexGuide/detailintro"
        />
        ...
        <script type="application/ld+json">
          {`
			...
			"url": "https://kikaporn.com/ComplexGuide/detailintro"
					}
					`}
        </script>
      </Helmet>
