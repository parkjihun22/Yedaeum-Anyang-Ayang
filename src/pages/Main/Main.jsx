...
const section3Contents = [
  ...
  },
  {
    ...
    title: "PREMIUM 03",
    text1: `안성을 잇는 사통팔달 광역교통망`,
    text2: `유천역(예정) 초역세권 프리미엄<br />
           안성역 CTX(예정) 및 <br /> 도시 광역교통 입지 `,
    link: "/LocationEnvironment/intro",
    linkText: "더 알아보기 >",
  },
  {
      ...
      {!isMobile ? (
        ...
        <>
          ...
          <div className={styles.imageContainer}>
            <img src={mainImage} className={styles.mainImage} alt="안성아양 영무예다음-mainimage1" />
            ...
            <div className={styles.mainImageTextBox}>
              ...
              <div className={styles.mainImageTitleBox}>
                <div className={styles.mainImageText}>안성이 기다린 가장 착한 아파트</div>
                <div className={styles.mainImageLine}></div>
                <div className={styles.mainImageText}>안성아양 영무예다음</div>
              </div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  ...
                  - 대청종합병원 도보 5분 <br />
                  - 안성 제1·2산업단지 및 벤처협동화 단지 인접 유천역(예정), 안성역 CTX(예정) <br />
                  - 모두를 누리는 안성아양 영무예다음
                </div>
              ...
              <div className={styles.menuBox}>
                <img src={section1_Image1} alt="안성아양 영무예다음브랜드소개-image2" />
            ...
            <div className={styles.section8}>
              <div className={styles.textBox}>
                <div className={styles.title}>
                  소수만 누릴 수 있는<br />
                  <span>착한가격의 아파트 <br />안성아양 영무예다음</span>
                </div>
              ...
              <img src={section8Img3} alt="안성아양 영무예다음입지환경소개-image2" />
            </div>
          </div>
            ...
            <div className={styles.section2}>
              <div className={styles.textBox}>
                ...
                <div className={`${styles.text2} fadeUpRepeat`}>
                  기대한 모든 프리미엄이<br />안성아양 영무예다음에서 펼쳐집니다
                </div>
              ...
              <img src={section2_Image1} alt="안성아양 영무예다음아파트 조감도-image3" />
            </div>
          </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img src={section4_Image1} alt="안성아양 영무예다음브랜드소개-image4" />
                <div className={styles.text1}>안성아양 영무예다음</div>
    ...
    <button type="submit">등록하기</button>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="안성아양 영무예다음오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            <img src={mobileImageMain} className={styles.mainImage} alt="안성아양 영무예다음mobilemain-image1" />
            <div className={styles.overlay}></div>
            <div className={styles.mainImageTextBox1}>
              ...
              <div className={styles.mainImageTitleBox1}>
                <div className={styles.mainImageText1}>안성이 기다린<br /> 가장 착한 아파트</div>
                <div className={styles.mainImageText5}>안성아양 영무예다음</div>
              </div>
            </div>
          </div>
          ...
          <div className={styles.container7}>
            ...
            <img src={section8Img3} alt="안성아양 영무예다음mobile입지안내-image1" />
          </div>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른<br />
                프리미엄 주거라이프를 안성아양 영무예다음 모델하우스에서 확인하세요
              </div>
            </div>
            <img src={section2_Image1} alt="안성아양 영무예다음mobile조감도-image1" />
          </div>
...
<div className={styles.mobileVisitContainer}>
  ...
  >
    ...
    <button type="submit">등록하기</button>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img src={mobilemap1} alt="안성아양 영무예다음오시는길안내-mobileimage2" />
            </div>
          </div> */}
